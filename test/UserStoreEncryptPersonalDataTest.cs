...
public class ProtectedUserStoreTest : SqlStoreTestBase<MongoIdentityUser, MongoIdentityRole, ObjectId>
{
        ...
        where TContext : DbContext
    {
            ...
            services.AddDbContext<TContext>(b => b.UseMongoDB(_fixture.ConnectionString, _fixture.DatabaseName));
    ...
    public void ProtectedPersonalDataThrowsOnNonString()
    {
        using (var scratch = new ScratchDatabaseFixture())
        {
            ...
            services.AddIdentity<CustomUser, MongoIdentityRole>(options =>
            {
                ...
                .AddPersonalDataProtection<InkProtector, DefaultKeyRing>();
            var dbOptions = new DbContextOptionsBuilder().UseMongoDB(scratch.ConnectionString, scratch.DatabaseName)                
